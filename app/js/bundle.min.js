...
!function(){var t={initialize:function(){this.setUpListeners(),this.sliderBorderRadius(),this.sliderBorderSize(),this.cssResult(),this.htmlResult()},btnResult:$(".result__button_prop"),htmlCodeResultArea:$("#html-code__text"),cssCodeResultArea:$("#css-code__text"),setUpListeners:function(){$("#slider__br-radius").on("slide change stop",$.proxy(this.borderRadChange,this)),$("#slider__br-size").on("slide change stop",$.proxy(this.borderSizeChange,this)),$(document).ready($.proxy(this.btnTextChange,this)),$("#btn-text_value").on("keyup",$.proxy(this.btnTextChange,this)),$("form").on("submit",t.submitForm),$("form").on("keydown","input",t.removeError),$(document).ready($.proxy(this.loadPageInFirefox,this))},loadPageInFirefox:function(){var e=4,r=1;t.ff_i1=e,t.ff_i2=r,this.cssResult()},sliderBorderRadius:function(){$("#slider__br-radius").slider({min:4,max:22,range:"min"})},borderRadChange:function(e,r){this.btnResult.css({"border-radius":r.value});var n=r.value;t.ff_i1=n,this.cssResult()},sliderBorderSize:function(){$("#slider__br-size").slider({min:1,max:6,range:"min"})},borderSizeChange:function(e,r){this.btnResult.css({"border-width":r.value});var n=r.value;t.ff_i2=n,this.cssResult()},btnTextChange:function(){var t=$("#btn-text_value").val();$("#result__button_value").text($("#btn-text_value").val()),""==t&&$("#result__button_value").text("Button text"),this.htmlResult()},cssResult:function(){var e=this.btnResult.css("border-radius"),r=this.btnResult.css("border-width");if(ua=navigator.userAgent,ua.search(/Firefox/)>-1||ua.search(/explorer/)){var e,r;e=t.ff_i1,r=t.ff_i2}this.cssCodeResultArea.text("/* CSS */\n/* Button. Код сгенерирован автоматически */\n.super-button {\n/* эти свойства меняются в генераторе */\n-webkit-border-radius: "+e+";\n-moz-border-radius: "+e+";\nborder-radius: "+e+";\nborder: "+r+" solid rgb(49, 129, 180);\n/* ------------------------------------- */\nheight: 45px;\nwidth: 140px;\nbackground-color: #37a1e4;\n-webkit-box-shadow: 0 1px 1px rgba(0,0,0,.19), inset 0 2px rgba(255,255,255,.58), inset 0 0 5px rgba(255,255,255,.38);\n-moz-box-shadow: 0 1px 1px rgba(0,0,0,.19), inset 0 2px rgba(255,255,255,.58), inset 0 0 5px rgba(255,255,255,.38);\nbox-shadow: 0 1px 1px rgba(0,0,0,.19), inset 0 2px rgba(255,255,255,.58), inset 0 0 5px rgba(255,255,255,.38);\nbackground-image: -webkit-linear-gradient(top, rgba(255,255,255,.26), rgba(255,255,255,0));\nbackground-image: -moz-linear-gradient(top, rgba(255,255,255,.26), rgba(255,255,255,0));\nbackground-image: -o-linear-gradient(top, rgba(255,255,255,.26), rgba(255,255,255,0));\nbackground-image: linear-gradient(to bottom, rgba(255,255,255,.26), rgba(255,255,255,0));\nfont-size: 16px;\nfont-weight: bold;\ncolor: #fff;\ntext-shadow: 0 1px rgba(0,0,0,.32);\n}\n/* Button end */")},htmlResult:function(){var t=$("#btn-text_value").val();""==t&&(t="Button text"),this.htmlCodeResultArea.text('<!-- HTML -->\n<!-- Button. Код сгенерирован автоматически -->\n<button class="super-button" id=""> '+t+" </button>\n<!-- Button end -->")},submitForm:function(e){e.preventDefault();var r=$(this);if(submitBtn=r.find('button[type="submit"]'),t.validateForm(r)===!1)return!1;submitBtn.attr("disabled","disabled");var n=r.serialize();$.ajax({url:"email_form/send.php",type:"POST",data:n}).done(function(t){if("OK"===t){var e="<div class='bg-success'>Код кнопки отправлен на ваш адрес электронной почты.</div>";r.html(e)}else r.html(t)}).always(function(){submitBtn.removeAttr("disabled")})},validateForm:function(t){var e=t.find("input"),r=!0;return e.tooltip("destroy"),$.each(e,function(t,e){var n=$(e),e=n.val(),i="Введите адрес электронной почты";0===e.length&&(n.tooltip({trigger:"manual",placement:"right",title:i}).tooltip("show"),r=!1)}),r},removeError:function(){}};t.initialize()}();