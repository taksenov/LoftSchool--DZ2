...
!function(){var t={initialize:function(){var t=this;t.setUpListeners(),t.sliderBorderRadius(),t.sliderBorderSize(),t.cssResult(),t.htmlResult()},btnResult:$(".result__button_prop"),htmlCodeResultArea:$("#html-code__text"),cssCodeResultArea:$("#css-code__text"),setUpListeners:function(){var e=this;$("#slider__br-radius").on("slide change stop",$.proxy(e.borderRadChange,e)),$("#slider__br-size").on("slide change stop",$.proxy(e.borderSizeChange,e)),$(document).ready($.proxy(e.btnTextChange,e)),$("#btn-text_value").on("keyup",$.proxy(e.btnTextChange,e)),$("form").on("submit",t.submitForm),$("form").on("keydown","input",t.removeError),$(document).ready($.proxy(e.loadPageInFirefox,e))},loadPageInFirefox:function(){var e=4,r=1,n=this;t.ff_i1=e,t.ff_i2=r,n.cssResult()},sliderBorderRadius:function(){$("#slider__br-radius").slider({min:4,max:22,range:"min"})},borderRadChange:function(e,r){var n=this;n.btnResult.css({"border-radius":r.value});var a=r.value;t.ff_i1=a,n.cssResult()},sliderBorderSize:function(){$("#slider__br-size").slider({min:1,max:6,range:"min"})},borderSizeChange:function(e,r){var n=this;n.btnResult.css({"border-width":r.value});var a=r.value;t.ff_i2=a,n.cssResult()},btnTextChange:function(){var t=this,e=$("#btn-text_value").val();$("#result__button_value").text($("#btn-text_value").val()),""===e&&$("#result__button_value").text("Button text"),t.htmlResult()},cssResult:function(){var e=this,r=e.btnResult.css("border-radius"),n=e.btnResult.css("border-width");if(ua=navigator.userAgent,ua.search(/Firefox/)>-1||ua.search(/explorer/)){var r,n;r=t.ff_i1,n=t.ff_i2}e.cssCodeResultArea.text("/* CSS */\n/* Button. Код сгенерирован автоматически */\n.super-button {\n/* эти свойства меняются в генераторе */\n-webkit-border-radius: "+r+";\n-moz-border-radius: "+r+";\nborder-radius: "+r+";\nborder: "+n+" solid rgb(49, 129, 180);\n/* ------------------------------------- */\nheight: 45px;\nwidth: 140px;\nbackground-color: #37a1e4;\n-webkit-box-shadow: 0 1px 1px rgba(0,0,0,.19), inset 0 2px rgba(255,255,255,.58), inset 0 0 5px rgba(255,255,255,.38);\n-moz-box-shadow: 0 1px 1px rgba(0,0,0,.19), inset 0 2px rgba(255,255,255,.58), inset 0 0 5px rgba(255,255,255,.38);\nbox-shadow: 0 1px 1px rgba(0,0,0,.19), inset 0 2px rgba(255,255,255,.58), inset 0 0 5px rgba(255,255,255,.38);\nbackground-image: -webkit-linear-gradient(top, rgba(255,255,255,.26), rgba(255,255,255,0));\nbackground-image: -moz-linear-gradient(top, rgba(255,255,255,.26), rgba(255,255,255,0));\nbackground-image: -o-linear-gradient(top, rgba(255,255,255,.26), rgba(255,255,255,0));\nbackground-image: linear-gradient(to bottom, rgba(255,255,255,.26), rgba(255,255,255,0));\nfont-size: 16px;\nfont-weight: bold;\ncolor: #fff;\ntext-shadow: 0 1px rgba(0,0,0,.32);\n}\n/* Button end */")},htmlResult:function(){var t=this,e=$("#btn-text_value").val();""===e&&(e="Button text"),t.htmlCodeResultArea.text('<!-- HTML -->\n<!-- Button. Код сгенерирован автоматически -->\n<button class="super-button" id=""> '+e+" </button>\n<!-- Button end -->")},submitForm:function(e){var r=this;e.preventDefault();var n=$(r);if(submitBtn=n.find('button[type="submit"]'),t.validateForm(n)===!1)return!1;submitBtn.attr("disabled","disabled");var a=n.serialize();$.ajax({url:"email_form/send.php",type:"POST",data:a}).done(function(t){if("OK"===t){var e="<div class='bg-success'>Код кнопки отправлен на ваш адрес электронной почты.</div>";$("#valid").html(e)}else $("#valid").html(t)}).always(function(){submitBtn.removeAttr("disabled")})},validateForm:function(t){var e=t.find("input"),r=!0;return e.tooltip("destroy"),$.each(e,function(t,e){var n=$(e),e=n.val(),a="Введите адрес электронной почты";0===e.length&&(n.tooltip({trigger:"manual",placement:"right",title:a}).tooltip("show"),r=!1)}),r},removeError:function(){}};t.initialize()}();